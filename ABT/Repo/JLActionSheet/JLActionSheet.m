...
- (void) showInView:(UIView *)parentView
{
    ...
    originalCenter = CGPointMake(buttonsParentView.center.x, buttonsParentView.center.y-18);
    [buttonsParentView setCenter:CGPointMake(buttonsParentView.center.x, (CGRectGetHeight(self.bounds) + (CGRectGetHeight(buttonsParentView.bounds))))];
